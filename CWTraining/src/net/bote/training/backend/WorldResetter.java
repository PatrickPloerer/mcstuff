...
public class WorldResetter {
    ...
    public static Boolean worldSaved(String worldName) {
        File worldFolder = new File("plugins/CWBWTraining/WorldSaves/" + worldName);
    ...
    public static void saveWorld(World world) {
        if (world != null) {
            world.save();
            File worldFolder = new File("plugins/CWBWTraining/WorldSaves/" + world.getName());
    ...
    public static void resetWorld(World world) {
        try {
            File srcWorldFolder = new File("plugins/CWBWTraining/WorldSaves/" + world.getName());
            ...
            if ((srcWorldFolder.exists()) &&
                ...
                if (world.getName().equals("world")) {
                    ...
                    kickPlayers(world);
                    Boolean saveSett = Boolean.FALSE;
                    Long seed = null;
    ...
    public static String getChunkGeneratorAsName(World world) {
        String generator = null;
