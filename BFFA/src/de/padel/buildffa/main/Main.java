...
public class Main extends JavaPlugin {
	  ...
	  public void connctMySQL() {
	    ...
	    try {
	      ...
	      mysql.update("CREATE TABLE IF NOT EXISTS BFFAItems(UUID varchar(64), sticks varchar(64), bloecke varchar(64), schwert varchar(60), killsound varchar(60), ruestungFarbe varchar(64), "
